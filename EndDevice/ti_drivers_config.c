...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_LED_GREEN_GPIO */
    /* Owned by CONFIG_LED_RED as LED GPIO */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_LED_RED_GPIO */
...
const uint_least8_t CONFIG_LED_RED_GPIO_CONST = CONFIG_LED_RED_GPIO;
const uint_least8_t CONFIG_LED_GREEN_GPIO_CONST = CONFIG_LED_GREEN_GPIO;
...
const SPICC26X2DMA_HWAttrs spiCC26X2DMAHWAttrs[CONFIG_SPI_COUNT] = {
    ...
    /* LaunchPad SPI Bus */
    {
        ...
        .mosiPin = CONFIG_PIN_SPI_MOSI,
        .misoPin = CONFIG_PIN_SPI_MISO,
...
static const LED_HWAttrs LEDHWAttrs[CONFIG_LED_COUNT] = {
    ...
    /* LaunchPad LED Green */
    {
        ...
        .index = CONFIG_LED_RED_GPIO,
    },
    /* CONFIG_LED_GREEN */
    /* LaunchPad LED Red */
    {
        .type = LED_GPIO_CONTROLLED,
        .index = CONFIG_LED_GREEN_GPIO,
    },
};

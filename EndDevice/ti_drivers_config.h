...
extern const uint_least8_t CONFIG_LED_RED_GPIO_CONST;
#define CONFIG_LED_RED_GPIO 7

/* Owned by CONFIG_LED_GREEN as  */
extern const uint_least8_t CONFIG_LED_GREEN_GPIO_CONST;
#define CONFIG_LED_GREEN_GPIO 6
